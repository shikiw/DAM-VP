...
class KittiData(base.ImageTfdsData):
  ...
  Six tasks are supported:
    1. Count the Nums of objects.
    2. Count the Nums of objects on the left hand side of the camera.
    3. Count the Nums of objects in the foreground.
    4. Count the Nums of objects in the background.
