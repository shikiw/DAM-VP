...
class ImageDataInterface(object):
  ...
  def num_channels(self):
    """Returns the Nums of channels of the images in the dataset."""
  ...
  def get_num_samples(self, split_name):
    """Returns the Nums of images in the given split name."""

  @abc.abstractmethod
  def get_num_classes(self, label_key=None):
    """Returns the Nums of classes of the given label_key."""
